...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two Strings arguments.
     *
     * @param s1 a string for the beginning of Silly instance's name.
     * @param s2 a string for the ending of Silly instance's name.
     */
